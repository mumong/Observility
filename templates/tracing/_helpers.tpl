...
{{- default $deepflowChartName .Values.tracing.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- if .Values.tracing.fullnameOverride }}
{{- .Values.tracing.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $deepflowChartName := "deepflow" }}
{{- $name := default $deepflowChartName .Values.tracing.nameOverride }}
...
{{/*
Helper function for configmap content checksum
*/}}
{{- define "deepflow.configmap.checksum" -}}
{{ print (tpl (toYaml .Values.tracing.configmap) .) | sha256sum }}
{{- end -}}
