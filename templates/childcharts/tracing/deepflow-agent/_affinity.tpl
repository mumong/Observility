...
{{- define "childcharts.tracing.deepflow-agent.nodeaffinity" }}
  nodeAffinity:
    requiredDuringSchedulingIgnoredDuringExecution:
    {{- include "childcharts.tracing.deepflow-agent.nodeAffinityRequiredDuringScheduling" . }}
    preferredDuringSchedulingIgnoredDuringExecution:
    {{- include "childcharts.tracing.deepflow-agent.nodeAffinityPreferredDuringScheduling" . }}
{{- end }}

{{- define "childcharts.tracing.deepflow-agent.nodeAffinityRequiredDuringScheduling" }}
...
{{- define "childcharts.tracing.deepflow-agent.nodeAffinityPreferredDuringScheduling" }}
...
{{- define "childcharts.tracing.deepflow-agent.podAffinity" }}
{{- if or .Values.podAffinityLabelSelector .Values.podAffinityTermLabelSelector}}
  podAffinity:
    {{- if .Values.podAffinityLabelSelector }}
    requiredDuringSchedulingIgnoredDuringExecution:
    {{- include "childcharts.tracing.deepflow-agent.podAffinityRequiredDuringScheduling" . }}
    {{- end }}
    {{- if or .Values.podAffinityTermLabelSelector}}
    preferredDuringSchedulingIgnoredDuringExecution:
    {{- include "childcharts.tracing.deepflow-agent.podAffinityPreferredDuringScheduling" . }}
    {{- end }}
{{- end }}
{{- end }}

{{- define "childcharts.tracing.deepflow-agent.podAffinityRequiredDuringScheduling" }}
...
{{- define "childcharts.tracing.deepflow-agent.podAffinityPreferredDuringScheduling" }}
...
{{- define "childcharts.tracing.deepflow-agent.podAntiAffinity" }}
{{- if or .Values.podAntiAffinityLabelSelector .Values.podAntiAffinityTermLabelSelector}}
  podAntiAffinity:
    {{- if .Values.podAntiAffinityLabelSelector }}
    requiredDuringSchedulingIgnoredDuringExecution:
    {{- include "childcharts.tracing.deepflow-agent.podAntiAffinityRequiredDuringScheduling" . }}
    {{- end }}
    {{- if or .Values.podAntiAffinityTermLabelSelector}}
    preferredDuringSchedulingIgnoredDuringExecution:
    {{- include "childcharts.tracing.deepflow-agent.podAntiAffinityPreferredDuringScheduling" . }}
    {{- end }}
{{- end }}
{{- end }}

{{- define "childcharts.tracing.deepflow-agent.podAntiAffinityRequiredDuringScheduling" }}
...
{{- define "childcharts.tracing.deepflow-agent.podAntiAffinityPreferredDuringScheduling" }}
