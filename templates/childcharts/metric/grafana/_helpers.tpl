...
{{/*
Default child chart values merged with metric.grafana.
*/}}
{{- define "childcharts.metric.grafana.defaults" -}}
{{- .Files.Get "files/childcharts/metric/grafana/values.yaml" -}}
{{- end -}}

{{- define "childcharts.metric.grafana.values" -}}
{{- if and .Values (hasKey .Values "metric") -}}
{{- $defaults := include "childcharts.metric.grafana.defaults" . | fromYaml -}}
{{- $userValues := get (get .Values "metric" | default dict) "grafana" | default dict -}}
